...
import {Card, List, Button, Skeleton, Input, Pagination, Spin} from 'antd';
...
const SpellList: React.FC = () => {
    ...
    const currentSpells = spells.filter((spell) =>
        spell.name.toLowerCase().startsWith(searchTerm.toLowerCase())
